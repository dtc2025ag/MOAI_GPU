...
// void moai::Evaluator::add_inplace_reduced_error(PhantomCiphertext &encrypted1, const PhantomCiphertext &encrypted2) {
...
// void moai::Evaluator::sub_inplace_reduced_error(PhantomCiphertext &encrypted1, const PhantomCiphertext &encrypted2) {
//   size_t encrypted1_coeff_modulus_size = encrypted1.coeff_modulus_size();
//   size_t encrypted2_coeff_modulus_size = encrypted2.coeff_modulus_size();
...
// void moai::Evaluator::multiply_inplace_reduced_error(PhantomCiphertext &encrypted1, const PhantomCiphertext &encrypted2, const PhantomRelinKey &relin_keys) {
//   size_t encrypted1_coeff_modulus_size = encrypted1.coeff_modulus_size();
//   size_t encrypted2_coeff_modulus_size = encrypted2.coeff_modulus_size();
